...
NSString * const StarbucksNotifierBundleID = @"notifications.jickpictures.Starbucks";
...
- (NSString *)__bundleIdentifier;
{
    if (self == [NSBundle mainBundle]) {
        return _fakeBundleIdentifier ? _fakeBundleIdentifier : StarbucksNotifierBundleID;
    } else {
