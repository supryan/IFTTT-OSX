...
NSString * const WellsFargoNotifierBundleID = @"notifications.jickpictures.WellsFargo";
...
- (NSString *)__bundleIdentifier;
{
    if (self == [NSBundle mainBundle]) {
        return _fakeBundleIdentifier ? _fakeBundleIdentifier : WellsFargoNotifierBundleID;
    } else {
