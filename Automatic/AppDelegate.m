...
NSString * const AutomaticNotifierBundleID = @"notifications.jickpictures.Automatic";
...
- (NSString *)__bundleIdentifier;
{
    if (self == [NSBundle mainBundle]) {
        return _fakeBundleIdentifier ? _fakeBundleIdentifier : AutomaticNotifierBundleID;
    } else {
